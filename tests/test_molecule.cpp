...
TEST_CASE("molecule class","Full test of molecule class") {
	SECTION("molecule class constructors")
	{
		...
		CHECK(b.get_canonical_formula() == "CH4");
		scifir::molecule c({ atom::C,atom::C,atom::C,atom::H,atom::H,atom::H,atom::H,atom::H,atom::H,atom::H,atom::H },{ {0,3},{0,4},{0,5},{1,6},{1,7},{2,8},{2,9},{2,10} });
		CHECK(c.get_canonical_formula() == "C3H8");
	}
}
